...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_notify_slack"></a> [notify\_slack](#module\_notify\_slack) | terraform-aws-modules/notify-slack/aws | 6.5.2 |
...
| [aws_cloudwatch_event_rule.apprunner_notifications](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_event_rule) | resource |
| [aws_cloudwatch_event_target.apprunner_notifications](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_event_target) | resource |
...
| [aws_sns_topic.apprunner_notifications](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic) | resource |
| [aws_sns_topic_policy.apprunner_notifications](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic_policy) | resource |
...
| [aws_iam_policy_document.apprunner_notifications](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_send_deployment_notifications_to_slack"></a> [send\_deployment\_notifications\_to\_slack](#input\_send\_deployment\_notifications\_to\_slack) | Do you want to send notifications to Slack (true/false)? | `bool` | `false` | no |
| <a name="input_service_name"></a> [service\_name](#input\_service\_name) | The name of the App Runner service. | `string` | n/a | yes |
| <a name="input_slack_channel"></a> [slack\_channel](#input\_slack\_channel) | The Slack channel where deployment notifications should be sent. | `string` | `""` | no |
| <a name="input_slack_username"></a> [slack\_username](#input\_slack\_username) | The username that should appear for Slack notifications. | `string` | `"AWS App Runner"` | no |
| <a name="input_slack_webhook_url"></a> [slack\_webhook\_url](#input\_slack\_webhook\_url) | The webhook URL for sending deployment notifications to Slack. | `string` | `""` | no |
